...
export const Footer = () => {
  return (
    <footer
      className="w-full mt-auto relative bg-cover bg-bottom bg-no-repeat text-[#f5efe6]"
      ...
      <div className="relative z-10">
        ...
        <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-5 gap-10 justify justify-content-center">
          ...
          <div className="flex flex-col gap-3 text-sm">
            ...
            <Link to="/franchise" onClick={scrollToTop} className="hover:text-gold-400 transition-colors">Contact Us</Link>
          </div>
